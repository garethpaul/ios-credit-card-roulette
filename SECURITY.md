...
- The pinned GitHub Actions macOS workflow uses read-only repository permissions and compiles
  the unsigned app and XCTest bundle without participant persistence, payment
  processing, or signing material.
